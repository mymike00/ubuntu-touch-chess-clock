...
UBUNTU_TRANSLATION_DOMAIN="chessclock.jonas"
...
aptest.commands = bash $$PWD/chessclock/tests/autopilot/run
aptest.depends  = sub-chessclock

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/chessclock/tests/unit 
unittest.depends  = sub-chessclock
